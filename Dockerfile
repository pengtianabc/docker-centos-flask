...
RUN (. /venvpy3/bin/activate && pip install -r /requirements.txt && pip install gevent==1.4.0 psycopg2-binary psycogreen uwsgitop Flask-APScheduler python-dateutil openpyxl pandas cryptography)
